...
SELECT order_id, customer_id, pizza_id, 
	...
	END AS extras,
		order_time
INTO _customer_orders
FROM customer_orders

--TABLE: runner_orders

--pickup_time - remove ' ' and replace with null
--distance - remove km and nulls
--duration - remove minutes and nulls
--cancellation - remove NULL and ' ' and replace with null 
...
--Change DATA TYPE for pickup_time, distance and duration

ALTER TABLE _runner_orders
